...
time.sleep(2)
soluong = driver.find_element_by_xpath(("/html/body/div[1]/div[2]/div/div/div/div[2]/form/div/input"))
soluong.send_keys("99")
...
time.sleep(2)
driver.find_element_by_xpath(("/html/body/div[1]/div[2]/div/div/div/div/div[1]/form/table/tbody/tr[1]/td[5]/div/input")).clear()
driver.find_element_by_xpath(("/html/body/div[1]/div[2]/div/div/div/div/div[1]/form/table/tbody/tr[1]/td[5]/div/input")).send_keys(7)
