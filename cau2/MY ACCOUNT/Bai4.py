...
time.sleep(2)
driver.find_element_by_xpath(("/html/body/div[1]/div[2]/div/div/div/div/div[1]/nav/ul/li[2]/a")).click()

time.sleep(2)
driver.find_element_by_xpath(("/html/body/div[1]/div[1]/header/div[2]/nav/ul/li[6]/a/span[2]")).click()
